...
export function EliminarCuentaModal({ abierto, onCerrar }: { abierto: boolean; onCerrar: () => void }) {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      >
        ...
        <p className="mt-2 text-sm leading-relaxed text-ink-700">
          Se marcará tu cuenta para eliminación. Perderás acceso al portal, a tus empresas, cargas
          financieras, indicadores, obligaciones y simulaciones. Escribe <strong>ELIMINAR</strong> para
          confirmar.
        </p>
        <div className="mt-4">
