...
export function AdminPlatformChart() {
  ...
  return (
    <AdminCard className="mt-5 p-4">
      ...
      <div className="mt-4 flex h-48 min-w-0 items-end gap-2 overflow-x-auto pb-6" aria-label="Registros y suscripciones por mes">
