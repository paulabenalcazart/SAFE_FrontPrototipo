...
const companyDefaults: FormState = { nombres: '', apellidos: '', correo: '', telefono: '', ruc: '', razon_social: '', nombre_comercial: '', correo_empresarial: '', telefono_empresarial: '', ciudad: 'Guayaquil', provincia: 'Guayas', direccion: '', giro_negocio: '', actividad_economica_id: 'act-001', cluster_id: 'clu-serv', estructura_societaria_id: 'str-sas', tipo_contribuyente_id: 'tax-001', tamano_empresa: 'MICRO', etapa_negocio: 'INICIAL', numero_empleados: '1', lleva_contabilidad: 'false', declara_impuestos: 'true' }
...
export function AdminRegistrationDialog({ kind, open, onClose }: { kind: AdminRegistrationKind | null; open: boolean; onClose: () => void }) {
  ...
  const validate = () => {
    ...
    if (kind === 'company') for (const field of requiredCompanyRelations) if (!form[field]) next[field] = 'Selecciona una relación válida.'
