...
var Collapsible = React9.forwardRef(
  __name9(function Collapsible2(props, forwardedRef) {
    const {
      __scopeCollapsible,
      open: openProp,
      defaultOpen,
...
var CollapsibleTrigger = React9.forwardRef(
  ...
  __name9(function CollapsibleTrigger2(props, forwardedRef) {
...
var CollapsibleContent = React9.forwardRef(
  // blank line to reduce diff noise
  __name9(function CollapsibleContent2(props, forwardedRef) {
...
var CollapsibleContentImpl = React9.forwardRef(__name9(function CollapsibleContentImpl2(props, forwardedRef) {
...
var DirectionProvider = __name10((props) => {
...
__name10(useDirection, "useDirection");
...
var Accordion = React11.forwardRef(
  // blank line to reduce diff noise
  __name11(function Accordion2(props, forwardedRef) {
...
var AccordionImplSingle = React11.forwardRef(
  // blank line to reduce diff noise
  __name11(function AccordionImplSingle2(props, forwardedRef) {
    const {
      value: valueProp,
      defaultValue,
      onValueChange = __name11(() => {
      }, "onValueChange"),
      collapsible = false,
    ...
    return (0, import_jsx_runtime7.jsx)(
      AccordionValueProvider,
      {
        ...
        value: React11.useMemo(() => value ? [value] : [], [value]),
        onItemOpen: setValue,
        onItemClose: React11.useCallback(() => collapsible && setValue(""), [collapsible, setValue]),
...
var AccordionImplMultiple = React11.forwardRef(__name11(function AccordionImplMultiple2(props, forwardedRef) {
  const {
    value: valueProp,
    defaultValue,
    onValueChange = __name11(() => {
  ...
  const handleItemOpen = React11.useCallback(
    (itemValue) => setValue((prevValue = []) => [...prevValue, itemValue]),
    [setValue]
  );
  const handleItemClose = React11.useCallback(
...
var AccordionImpl = React11.forwardRef(
  __name11(function AccordionImpl2(props, forwardedRef) {
    const { __scopeAccordion, disabled, dir, orientation = "vertical", ...accordionProps } = props;
    const accordionRef = React11.useRef(null);
    ...
    const handleKeyDown = composeEventHandlers(props.onKeyDown, (event) => {
      ...
      const moveNext = __name11(() => {
        nextIndex = triggerIndex + 1;
        if (nextIndex > endIndex) {
          nextIndex = homeIndex;
        }
      }, "moveNext");
      const movePrev = __name11(() => {
        nextIndex = triggerIndex - 1;
...
var AccordionItem = React11.forwardRef(
  __name11(function AccordionItem2(props, forwardedRef) {
...
var AccordionHeader = React11.forwardRef(
  // blank line to reduce diff noise
  __name11(function AccordionHeader2(props, forwardedRef) {
...
var AccordionTrigger = React11.forwardRef(
  // blank line to reduce diff noise
  __name11(function AccordionTrigger2(props, forwardedRef) {
...
var AccordionContent = React11.forwardRef(
  // blank line to reduce diff noise
  __name11(function AccordionContent2(props, forwardedRef) {
